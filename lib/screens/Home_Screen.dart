...
import 'package:traval_app/widgets/DestinationCarousel.dart';
import 'package:traval_app/widgets/HotelCarousel.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  //Conctruct the widget of the icons
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: _icons
                    ...
                    .entries
                    .map(
                      (MapEntry map) => buildIcons(map.key)
                    ).toList(),
              ),
              SizedBox(height: 20.0,),
              DistinationCarousel(),
